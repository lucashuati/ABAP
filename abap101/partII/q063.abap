* QUESTAO 63 - Write an executable program which has a routine that receives a standard internal table. The
...
FORM replace_table.
  ...
  LOOP AT itab INTO wa .
    REPLACE ALL OCCURRENCES OF ` ` IN wa-c1 WITH '_'.
    REPLACE ALL OCCURRENCES OF ` ` IN wa-c2 WITH '_'.
    REPLACE ALL OCCURRENCES OF ` ` IN wa-c3 WITH '_'.
